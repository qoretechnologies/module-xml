...
The native XSD 1.0 schema compiler checks numeric and boolean default/fixed
...
Lists join selected item spellings with one space. Numeric/boolean union members
...
This is a schema-declaration correction for integer, decimal and boolean families,
