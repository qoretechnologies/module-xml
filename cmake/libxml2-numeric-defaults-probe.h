...
static int check_numeric_defaults(void) {
    static const char *types[] = {"int", "boolean", "decimal"};
    static const char *values[] = {"+017", "1", "017.00"};
    static const char *patterns[] = {"\\+017", "1", "017\\.00"};
    static const char *canonical[] = {"17", "true", "17\\.0"};
